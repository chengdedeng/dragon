...
public class AnnotationMapperImpl implements AnnotationMapper {
    ...
    @Override
    public List<AnnotationPojo> getAnnotation(String spanId) {
        return sqlSession.selectList("getAnnotatin", spanId);
    }

    @Override
    public void deleteAnnotation(String spanId) {
        sqlSession.delete("deleteAnnotationBySpanid", spanId);
    }
}
